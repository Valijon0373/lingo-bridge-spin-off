...
class ExcelService {
    ...
    async generateOrdersExcel() {
        const orders = await order_repository_1.orderRepository.findAllForExport();
        ...
        const statusTranslations = {
            [client_1.OrderStatus.PENDING]: '🟡 Kutilmoqda',
            [client_1.OrderStatus.WAITING_PAYMENT]: '⏳ To‘lov kutilmoqda',
            [client_1.OrderStatus.PAID]: '🟢 To‘langan',
            [client_1.OrderStatus.IN_PROGRESS]: '🔵 Jarayonda',
            [client_1.OrderStatus.COMPLETED]: '✅ Tugallangan',
            [client_1.OrderStatus.CANCELLED]: '❌ Bekor qilingan',
            [client_1.OrderStatus.REFUNDED]: '↩️ Qaytarilgan',
        };
        // Populate Rows
